...
class RawTushareFinaIndicator(Base):
    ...
    # update_flag 加入主键，区分同一公司同一报告期的多次更新
    update_flag: Mapped[str] = mapped_column(String(4), primary_key=True, server_default="0")
    # 每股指标
    eps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    dt_eps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    total_revenue_ps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    revenue_ps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    capital_rese_ps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    surplus_rese_ps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    undist_profit_ps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    cash_ratio: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # 营运能力
    invturn_days: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    arturn_days: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    inv_turn: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ar_turn: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ca_turn: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fa_turn: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    assets_turn: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # 盈利能力
    ...
    # 更多每股指标
    diluted2_eps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    bps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ocfps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    retainedps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    cfps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ebit_ps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fcff_ps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fcfe_ps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # 盈利能力比率
    netprofit_margin: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    grossprofit_margin: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    cogs_of_sales: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    expense_of_sales: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    profit_to_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    saleexp_to_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    adminexp_of_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    finaexp_of_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    impai_ttm: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    gc_of_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    op_of_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ebit_of_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # 收益率
    roe: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    roe_waa: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    roe_dt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    roa: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    npta: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    roic: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    roe_yearly: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    roa2_yearly: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    roe_avg: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # 其他指标
    opincome_of_ebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    investincome_of_ebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_op_profit_of_ebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    tax_to_ebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    dtprofit_to_profit: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    salescash_to_or: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ocf_to_or: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ocf_to_opincome: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    capitalized_to_da: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    debt_to_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    assets_to_eqt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    dp_assets_to_eqt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ca_to_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    nca_to_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    tbassets_to_totalassets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    int_to_talcap: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    eqt_to_talcapital: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    currentdebt_to_debt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    longdeb_to_debt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ocf_to_shortdebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    debt_to_eqt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    eqt_to_debt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    eqt_to_interestdebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    tangibleasset_to_debt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    tangasset_to_intdebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    tangibleasset_to_netdebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ocf_to_debt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ocf_to_interestdebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ocf_to_netdebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ebit_to_interest: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    longdebt_to_workingcapital: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ebitda_to_debt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    turn_days: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    roa_yearly: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    roa_dp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    op_to_ebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    nop_to_ebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ocf_to_profit: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    cash_to_liqdebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    cash_to_liqdebt_withinterest: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    op_to_liqdebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    op_to_debt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    roic_yearly: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    total_fa_trun: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    profit_to_op: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # 单季度指标
    ...
    q_eps: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_netprofit_margin: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_gsprofit_margin: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_exp_to_sales: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_profit_to_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_saleexp_to_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_adminexp_to_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_finaexp_to_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_impair_to_gr_ttm: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_gc_to_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_op_to_gr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_roe: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_dt_roe: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_npta: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_opincome_to_ebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_investincome_to_ebt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_dtprofit_to_profit: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_salescash_to_or: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_ocf_to_sales: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_ocf_to_or: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # 同比增长率
    basic_eps_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    dt_eps_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    cfps_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    op_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ebt_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    netprofit_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    dt_netprofit_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ocf_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    roe_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    bps_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    assets_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    eqt_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    tr_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    or_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_gr_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_gr_qoq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_sales_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_sales_qoq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_op_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_op_qoq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_profit_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_profit_qoq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_netprofit_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    q_netprofit_qoq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    equity_yoy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
...
class RawTushareIncome(Base):
    ...
    # numeric fields (alphabetical)
    adj_lossgain: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    admin_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ass_invest_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    assets_impair_loss: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    basic_eps: Mapped[float | None] = mapped_column(Numeric(12, 4), nullable=True)
    biz_tax_surchg: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    capit_comstock_div: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    comm_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    comm_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    compens_payout: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    compens_payout_refu: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    compr_inc_attr_m_s: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    compr_inc_attr_p: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    comshare_payable_dvd: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    diluted_eps: Mapped[float | None] = mapped_column(Numeric(12, 4), nullable=True)
    distable_profit: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    distr_profit_shrhder: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    div_payt: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ebit: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ebitda: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fin_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fin_exp_int_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fin_exp_int_inc: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    forex_gain: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fv_value_chg_gain: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    income_tax: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    insur_reser_refu: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    insurance_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    int_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    int_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    invest_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    minority_gain: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_asset_mg_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_commis_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    n_oth_b_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_oth_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_sec_tb_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_sec_uw_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    nca_disploss: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    oper_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    operate_profit: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_b_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_compr_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    other_bus_cost: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    out_prem: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    prem_earned: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    prem_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    prem_refund: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    prfshare_payable_dvd: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    rd_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    reins_cost_refund: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    reins_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    reins_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    reser_insur_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    t_compr_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    transfer_housing_imprest: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    transfer_oth: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    transfer_surplus_rese: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    undist_profit: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    une_prem_reser: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    withdra_biz_devfund: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    withdra_legal_pubfund: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    withdra_legal_surplus: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    withdra_oth_ersu: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    withdra_rese_fund: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    workers_welfare: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fetched_at: Mapped[datetime] = mapped_column(
        DateTime, server_default=func.now()
    )
...
class RawTushareBalancesheet(Base):
    ...
    update_flag: Mapped[str | None] = mapped_column(String(4), nullable=True)
    # numeric fields (alphabetical)
    acc_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    acc_receivable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    accounts_pay: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    accounts_receiv: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    accounts_receiv_bill: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    acct_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    acting_trading_sec: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    acting_uw_sec: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    adv_receipts: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    agency_bus_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    amor_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    cash_reser_cb: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    cb_borr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    cip: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    cip_total: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    client_depos: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    client_prov: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    comm_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    const_materials: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    cost_fin_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    debt_invest: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    decr_in_disbur: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    defer_inc_non_cur_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    defer_tax_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    defer_tax_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    deferred_inc: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    depos: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    depos_ib_deposits: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    depos_in_oth_bfi: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    depos_oth_bfi: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    depos_received: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    deriv_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    deriv_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    div_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    div_receiv: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    estimated_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fa_avail_for_sale: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fair_value_fin_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fix_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fix_assets_total: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fixed_assets_disp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    forex_differ: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    goodwill: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    hfs_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    hfs_sales: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    htm_invest: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    indem_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    indep_acct_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    indept_acc_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    int_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    int_receiv: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    invest_as_receiv: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    invest_loss_unconf: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    invest_real_estate: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    lending_funds: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    loan_oth_bank: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    loanto_oth_bank_fi: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    long_pay_total: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    lt_amor_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    lt_borr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    lt_eqt_invest: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    lt_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    lt_payroll_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    lt_rec: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    nca_within_1y: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    non_cur_liab_due_1y: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    oil_and_gas_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ordin_risk_reser: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_comp_income: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_cur_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_cur_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_debt_invest: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_eqt_tools: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_eqt_tools_p_shr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_nca: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_ncl: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_pay_total: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_rcv_total: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_receiv: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    payable_to_reinsurer: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    payables: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    payroll_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ph_invest: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ph_pledge_loans: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    pledge_borr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    policy_div_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    prec_metals: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    prem_receiv_adva: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    premium_receiv: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    prepayment: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    produc_bio_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    pur_resale_fa: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    r_and_d: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    refund_cap_depos: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    refund_depos: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    reinsur_receiv: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    reinsur_res_receiv: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    reser_lins_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    reser_lthins_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    reser_outstd_claims: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    reser_une_prem: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    rr_reins_lins_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    rr_reins_lthins_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    rr_reins_outstd_cla: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    rr_reins_une_prem: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    rsrv_insur_cont: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    sett_rsrv: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    sold_for_repur_fa: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    special_rese: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    specific_payables: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    st_bonds_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    st_borr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    st_fin_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    surplus_rese: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    taxes_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    time_deposits: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    total_liab_hldr_eqy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    total_share: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    trad_asset: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    trading_fl: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    transac_seat_fee: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
...
class RawTushareCashflow(Base):
    ...
    update_flag: Mapped[str | None] = mapped_column(String(4), nullable=True)
    # numeric fields (alphabetical)
    amort_intang_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    beg_bal_cash: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    beg_bal_cash_equ: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    c_disp_withdrwl_invest: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    c_fr_oth_operate_a: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    c_inf_fr_operate_a: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    c_paid_invest: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    c_pay_claims_orig_inco: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    c_pay_dist_dpcp_int_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    c_prepay_amt_borr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    c_recp_borrow: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    c_recp_cap_contrib: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    c_recp_return_invest: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    conv_copbonds_due_within_1y: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    conv_debt_into_cap: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    credit_impa_loss: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    decr_def_inc_tax_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    decr_deferred_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    decr_inventories: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    decr_oper_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    depr_fa_coga_dpba: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    eff_fx_flu_cash: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    end_bal_cash: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    end_bal_cash_equ: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fa_fnc_leases: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    finan_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    free_cashflow: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ifc_cash_incr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    im_n_incr_cash_equ: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    im_net_cashflow_oper_act: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    incl_cash_rec_saims: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    incl_dvd_profit_paid_sc_ms: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    incr_acc_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    incr_def_inc_tax_liab: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    incr_oper_payable: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    invest_loss: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    loss_disp_fiolta: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    loss_fv_chg: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    loss_scr_fa: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    lt_amort_deferred_exp: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_cap_incr_repur: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ...
    n_depos_incr_fi: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_disp_subs_oth_biz: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_inc_borr_oth_fi: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_incr_cash_cash_equ: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_incr_clt_loan_adv: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_incr_dep_cbob: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_incr_disp_faas: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_incr_disp_tfa: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_incr_insured_dep: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_incr_loans_cb: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_incr_loans_oth_bank: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_incr_pledge_loan: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_recp_disp_fiolta: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_recp_disp_sobu: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    n_reinsur_prem: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    net_cash_rece_sec: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    net_dism_capital_add: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    net_profit: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_cash_pay_oper_act: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_cash_recp_ral_fnc_act: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_cashpay_ral_fnc_act: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_loss_asset: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_pay_ral_inv_act: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    oth_recp_ral_inv_act: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    others: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    pay_comm_insur_plcy: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    pay_handling_chrg: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    prem_fr_orig_contr: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    proc_issue_bonds: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    prov_depr_assets: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    recp_tax_rends: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    st_cash_out_act: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    stot_cash_in_fnc_act: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    stot_cashout_fnc_act: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    stot_inflows_inv_act: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    stot_out_inv_act: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    uncon_invest_loss: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    use_right_asset_dep: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fetched_at: Mapped[datetime] = mapped_column(
        DateTime, server_default=func.now()
    )
...
class RawTushareIndexFactorPro(Base):
    """指数技术面因子原始表（对应 idx_factor_pro 接口，doc_id=358）。"""
    ...
    pct_change: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    vol: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    amount: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # ASI 振动升降指标
    asi_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    asit_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # ATR 真实波幅
    atr_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # BBI 多空指标
    bbi_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # BIAS 乖离率
    bias1_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    bias2_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    bias3_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # BOLL 布林带
    boll_lower_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    boll_mid_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    boll_upper_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # BRAR 情绪指标
    brar_ar_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    brar_br_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # CCI 顺势指标
    cci_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # CR 能量指标
    cr_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # DFMA 平行线差指标
    dfma_dif_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    dfma_difma_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # DMI 趋向指标
    dmi_adx_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    dmi_adxr_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    dmi_mdi_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    dmi_pdi_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # Days 连涨连跌天数
    ...
    # DPO 区间震荡线
    dpo_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    madpo_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # EMA 指数移动平均
    ema_bfq_5: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ema_bfq_10: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ema_bfq_20: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ema_bfq_30: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ema_bfq_60: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ema_bfq_90: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ema_bfq_250: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # EMV 简易波动指标
    emv_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    maemv_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # EXPMA 指数平滑移动平均
    expma_12_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    expma_50_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # KDJ 随机指标
    kdj_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    kdj_d_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    kdj_k_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # KTN 肯特纳通道
    ktn_down_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ktn_mid_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ktn_upper_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # MA 简单移动平均
    ma_bfq_5: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ma_bfq_10: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ma_bfq_20: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ma_bfq_30: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ma_bfq_60: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ma_bfq_90: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ma_bfq_250: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # MACD 指标
    macd_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    macd_dea_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    macd_dif_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # MASS 梅斯线
    mass_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    ma_mass_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # MFI 资金流量指标
    mfi_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # MTM 动量指标
    mtm_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    mtmma_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # OBV 能量潮
    obv_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # PSY 心理线
    psy_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    psyma_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # ROC 变动率
    roc_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    maroc_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # RSI 相对强弱
    rsi_bfq_6: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    rsi_bfq_12: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    rsi_bfq_24: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # TAQ 唐奇安通道
    taq_down_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    taq_mid_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    taq_up_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # TRIX 三重指数平滑
    trix_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    trma_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # VR 成交量变异率
    vr_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # WR 威廉指标
    wr_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    wr1_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    # XSII 薛斯通道
    xsii_td1_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    xsii_td2_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    xsii_td3_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    xsii_td4_bfq: Mapped[float | None] = mapped_column(Numeric(20, 4), nullable=True)
    fetched_at: Mapped[datetime] = mapped_column(
        DateTime, server_default=func.now()
    )
...
class RawTushareSuspendD(Base):
    ...
    API 实际返回字段：ts_code, trade_date, suspend_timing, suspend_type
    trade_date 映射为 suspend_date（主键）。
    """
    ...
    suspend_type: Mapped[str | None] = mapped_column(String(4), nullable=True)
    fetched_at: Mapped[datetime] = mapped_column(
        DateTime, server_default=func.now()
    )
