...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("positive_sectors", postgresql.JSONB, nullable=False, server_default="'[]'::jsonb"),
        sa.Column("negative_sectors", postgresql.JSONB, nullable=False, server_default="'[]'::jsonb"),
        sa.Column("macro_summary", sa.Text, nullable=False),
        sa.Column("key_drivers", postgresql.JSONB, nullable=False, server_default="'[]'::jsonb"),
    ...
    op.create_table(
        ...
        sa.Column("drivers", postgresql.JSONB, nullable=False, server_default="'[]'::jsonb"),
        sa.Column("created_at", postgresql.TIMESTAMP(timezone=True), nullable=False, server_default=sa.func.now()),
        sa.Column("updated_at", postgresql.TIMESTAMP(timezone=True), nullable=False, server_default=sa.func.now()),
    ...
    op.create_table(
        ...
        sa.Column("plan_status", sa.String(16), nullable=False, server_default="'PENDING'"),
        ...
        sa.Column("emergency_exit_config", postgresql.JSONB, nullable=False, server_default="'{}'::jsonb"),
        ...
        sa.Column("confidence", sa.Numeric(5, 2), nullable=False),
        sa.Column("reasoning", postgresql.JSONB, nullable=False, server_default="'[]'::jsonb"),
        sa.Column("risk_flags", postgresql.JSONB, nullable=False, server_default="'[]'::jsonb"),
        sa.Column("created_at", postgresql.TIMESTAMP(timezone=True), nullable=False, server_default=sa.func.now()),
        sa.Column("updated_at", postgresql.TIMESTAMP(timezone=True), nullable=False, server_default=sa.func.now()),
